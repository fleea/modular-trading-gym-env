...
from .trend_observation_percentage import TrendObservationPercentage  # Replace 'your_module' with the actual module name
...
def test_calculate_trend(trend_observation, mock_env):
    ...
    assert trends[1] == approx(22.727272727272727, rel=1e-5)  # ((1.35 - 1.1) / 1.1) * 100
